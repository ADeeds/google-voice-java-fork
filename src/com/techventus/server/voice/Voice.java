...
public class Voice {
	...
	public Collection<SMSThread> getUnreadSMSThreads() throws IOException {
		Collection<SMSThread> unread = new LinkedList<SMSThread>();
		for (SMSThread thread : getSMSThreads()) {
			if (!thread.getRead()) unread.add(thread);
		}
		return unread;
	}		
